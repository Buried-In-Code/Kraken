 ...
 *
 * This utility function provides a consistent way to log messages across different levels (e.g., TRACE, DEBUG, INFO,
 * WARN, ERROR) by delegating to the corresponding logging method of the [KLogger].
 *
...
internal const val VERSION = "0.4.0"
